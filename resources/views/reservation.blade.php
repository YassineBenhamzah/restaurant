...
<form action="{{url('contact')}}" method="post">
            ...
            <div class="col-md-offset-2 col-md-8">
                <div class="form-group">
                    <input type="number" name="phone" class="form-control" placeholder="Your Phone"><br>
                </div>
            </div>
            <div class="col-md-offset-2 col-md-8">
                <div class="form-group">
            ...
            <div class="col-md-offset-2 col-md-8">
                <div class="form-group">
                    <input type="message" name="message" class="form-control" placeholder="Subject"><br>
                </div>
            </div>
            <div class="col-md-offset-2 col-md-8">
                <div class="form-group">
                    <input type="message" name="message" class="form-control" placeholder="message"><br>
                </div>
            </div>
